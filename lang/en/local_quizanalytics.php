...
$string['analyticslastupdated'] = 'Analytics last updated: {$a}';
$string['showingquizzes'] = 'Showing {$a} of {total} quizzes';
$string['noquizzesselected'] = 'No quizzes selected. Select one or more quizzes to display analytics.';
...
$string['progressqueued'] = 'Analytics calculation queued.';
$string['progresspreparing'] = 'Preparing course analytics.';
$string['progressprocessing'] = 'Processing quiz {$a->completed} of {$a->total}.';
$string['progressanalyzing'] = 'Building the analytics report.';
$string['progresssaving'] = 'Saving the completed report.';
$string['progresscomplete'] = 'Analytics calculation complete.';
$string['progressfailed'] = 'Analytics calculation failed. The previous report remains available.';
